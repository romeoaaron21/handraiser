...
class Splash extends React.Component {
    ...
    componentDidMount = () => {
        axios.get(`http://api.giphy.com/v1/gifs/trending?api_key=NUK2jPG9u330Lg9QqIPjGMuX13oG0loS&limit=9`)
        .then(res => {
            this.setState({
    ...
    moreTrend = () => {
        ...
        axios.get(`http://api.giphy.com/v1/gifs/trending?api_key=NUK2jPG9u330Lg9QqIPjGMuX13oG0loS&limit=10&offset=${this.state.trendPage}`)
        .then(res => {
            this.setState({
    ...
    handleSubmit = () => {
        axios.get(`http://api.giphy.com/v1/gifs/search?q=${this.state.query}&api_key=NUK2jPG9u330Lg9QqIPjGMuX13oG0loS&limit=9`)
        .then(res => {
            this.setState({
                showTrend: false,
    ...
    more = () => {
        ...
        axios.get(`http://api.giphy.com/v1/gifs/search?q=${this.state.query}&api_key=NUK2jPG9u330Lg9QqIPjGMuX13oG0loS&limit=10&offset=${this.state.resultPage}`)
        .then(res => {
            this.setState({
